...
// Función recursiva para contar campos que contienen URLs de archivos
const countFiles = (data: unknown): number => {
  if (data === null || data === undefined) return 0;
  if (typeof data === "string") {
    // Consideramos una cadena no vacía que parece URL o nombre de archivo (contiene / o extensión) como un archivo
...
const DashboardPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const loadSectionStatus = async () => {
      // Cargar todos los datos del curriculum para contar archivos
      ...
      // Construir objeto con todos los datos para contar archivos
      const allData = {
  ...
  const stats = [
    ...
    { label: "Documentos Adjuntos", value: totalFiles.toString(), iconClass: "green", icon: "📎" },
